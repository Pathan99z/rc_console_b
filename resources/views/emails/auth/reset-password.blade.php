                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 22px;font-size:15px;line-height:1.6;">
                                We received a request to reset your {{ $appName }} password. Click the button below to continue.
                            </p>
                            <p style="margin:0 0 26px;">
                                <a href="{{ $resetUrl }}" style="background:#2563EB;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:8px;display:inline-block;font-weight:600;">
                                    Reset Password
                                </a>
                            </p>
